...
description: "This study aimed to answer the following research question: Is there a correlation between eviction rates and incarceration? Simple statistical analysis reveals a strong positive correlation between eviction filing rates and incarceration rates in New York City zip codes."
output:
...
```
There is a strong negative correlation between white-majority zip codes and the imprisonment rate in New York City. Zip codes with a white-majority have a lower imprisonmet rate.
